...
class M_api extends CI_Model {
  ...
  {
    $sql = "SELECT sum(jumlah) as jumlah FROM tb_pinjaman WHERE user_id = $id";
    $result = $this->db->query($sql);
    return $result->row();
  }
  ...
  {
    $sql = "SELECT sum(angsuran) as angsuran, sum(tenor) as tenor FROM tb_pinjaman WHERE user_id = $id";
    $result = $this->db->query($sql);
    return $result->row();
  }
