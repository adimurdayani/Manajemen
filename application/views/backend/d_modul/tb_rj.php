              ...
              <div class="table-responsive">
                <table id="table" class="table">
                  ...
                  <tbody>
                    ...
                    <?php $no = 1; foreach($get_rj as $data):?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url('backend/modul/detailrj/') . $data['id']?>" class="btn btn-success"><i
      ...
      <form action="<?= base_url('backend/modul')?>" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="no_rekam_jalan" name="no_rekam_jalan"
                  value="N-<?= sprintf("%05s", $no_rekam)?>RJ" readonly>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="umur" name="umur" value="<?= set_value('umur')?>">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" id="tgl_berobat" name="tgl_berobat"
              value="<?= set_value('tgl_berobat')?>">
            <?= form_error('tgl_berobat', '<small class="text-danger">', '</small>')?>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="p_jawab" name="p_jawab" value="<?= set_value('p_jawab')?>">
            <?= form_error('p_jawab', '<small class="text-danger">', '</small>')?>
          </div>
          ...
          <div class="form-group">
            ...
            <?= form_error('a_p_jawab', '<small class="text-danger">', '</small>')?>
          </div>
          ...
          <div class="row">
            <div class="col md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="phone_p_jawab" name="phone_p_jawab"
                  value="<?= set_value('phone_p_jawab')?>">
                <?= form_error('phone_p_jawab', '<small class="text-danger">', '</small>')?>
              </div>
            </div>
            <div class="col md-6">
              <div class="form-group">
                <label class="floating-label" for="pekerjaan_p_jawab">Pekerjaan</label>
                <input type="text" class="form-control" id="pekerjaan_p_jawab" name="pekerjaan_p_jawab"
                  value="<?= set_value('pekerjaan_p_jawab')?>">
                <?= form_error('pekerjaan_p_jawab', '<small class="text-danger">', '</small>')?>
              </div>
            </div>
          </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="floating-label" for="no_rekam_jalan">No. Rekam Medis </label>
                <input type="text" class="form-control" id="no_rekam_jalan" name="no_rekam_jalan" readonly
                  value="<?= $edit['no_rekam_jalan']?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <label class="floating-label" for="a_p_jawab">Alamat Penanggung Jawab</label>
            <textarea name="a_p_jawab" id="a_p_jawab" cols="30" rows="5"
              class="form-control"><?= $edit['a_p_jawab']?></textarea>
            <?= form_error('a_p_jawab', '<small class="text-danger">', '</small>')?>
          </div>
