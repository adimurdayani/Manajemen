              ...
              <form action="<?= base_url('backend/user/member_detail/'). $get_member['id_m'];?>" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="member_id" name="member_id"
                    value="<?= $get_member['member_id']?>" readonly>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control" id="t_lahir" name="t_lahir"
                        value="<?= $get_member['t_lahir']?>">
                    ...
                    <div class="form-group">
                      ...
                      <select name="kelamin" id="kelamin" class="form-control">
                        <option value="Perempuan"
                          <?php if($get_member['kelamin'] != "Perempuan"):?><?php else:?>selected<?php endif;?>>
                          Perempuan</option>
                        <option value="Laki-laki"
                          <?php if($get_member['kelamin'] != "Laki-laki"):?><?php else:?>selected<?php endif;?>>
                          Laki-laki</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="agama" id="agama" class="form-control">
                        <option value="Islam"
                          <?php if($get_member['agama'] != "Islam"):?><?php else:?>selected<?php endif;?>>Islam</option>
                        <option value="Hindu"
                          <?php if($get_member['agama'] != "Hindu"):?><?php else:?>selected<?php endif;?>>Hindu</option>
                        <option value="Buda"
                          <?php if($get_member['agama'] != "Buda"):?><?php else:?>selected<?php endif;?>>Buda</option>
                        <option value="Kristen"
                          <?php if($get_member['agama'] != "Kristen"):?><?php else:?>selected<?php endif;?>>Kristen
                        </option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <textarea name="alamat" id="alamat" cols="30" rows="5"
                    class="form-control"><?= $get_member['alamat']?></textarea>
